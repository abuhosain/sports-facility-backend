...
const convertTimeStringToMinutes = (timeString: string): number => {
  ...
  export const getAvailableTimeSlots = (bookings: any[]): { startTime: string; endTime: string }[] => {
    ...
    bookings.sort((a: any, b: any) => convertTimeStringToMinutes(a.startTime) - convertTimeStringToMinutes(b.startTime));
